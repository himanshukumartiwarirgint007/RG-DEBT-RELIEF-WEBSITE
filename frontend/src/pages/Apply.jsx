              ...
              <div className="mt-6">
                <label className="flex items-start gap-2 cursor-pointer">
                  ...
                  <span className="text-xs text-gray-600">
                    By providing my phone number and opting in, I consent to receive marketing SMS text messages from Clarity Debt Resolution Inc. at the number provided, including messages sent by an automatic telephone dialing system (auto-dialer). I understand that consent is not a condition of purchase, and I can opt out at any time. I will receive 1-4 messages per month. Standard message and data rates may apply. To opt out of future messages, reply STOP. For help, reply HELP or contact us at support@usclarity.com. For more information check our Privacy Policy
                  </span>
                </label>
              </div>
            ...
            <div className={`${page === 2 ? "block animate-fadeIn" : "hidden"}`}>
              ...
              <div className="mt-6 p-4">
                <label className="flex items-start gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-xs text-gray-600">
                    By clicking "Submit", I provide express written consent for Clarity Debt Resolution to contact me via email, phone calls, and/or text messages at the phone number associated with my account. This includes communications regarding scheduling, account alerts (US Clarity Alerts), and authorizing account transactions. I consent to the use of any telephone dialing system, including prerecorded or artificial voice messages and/or automatic dialing devices, as applicable, for sending these communications. My phone number and SMS consent will not be shared with third parties for any reason, and Msg & data rates may apply. Messaging frequency may vary. I can text HELP for assistance or email support@usclarity.com for additional support, and I can text STOP at any time to cancel these messages. Even if my phone number is on any state or federal Do-Not-Call list, I still authorize these communications. I understand that I can revoke this consent at any time and that opting in is not a condition for receiving services from Clarity Debt Resolution. It is my responsibility to keep my phone number updated for these purposes.
                  </span>
                </label>
              </div>
