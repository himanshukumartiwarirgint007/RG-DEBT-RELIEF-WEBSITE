  ...
  return (
    <div className="w-full">
      ...
      <section className="text-center px-6 py-20 max-w-6xl mx-auto">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-[#5088B5] mb-4">About Us</h1>
      ...
      <section className="py-20 text-white px-4 backdrop-blur-sm" style={{ background: 'linear-gradient(100deg, rgba(17, 38, 99, 0.85), rgba(59, 130, 246, 0.85))', opacity: 0.95, borderRadius: '0.5rem', transition: 'background 0.3s ease, opacity 0.3s ease' }}>
